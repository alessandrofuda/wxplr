    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="{{ asset('/admin/dist/img/user2-160x160.jpg') }}" alt="{{ Auth::user()->name }}"  class="img-circle" alt="User Image">
          {{--  aggiunge, se presente, la propria foto nella dashboard in sidebar in alto a sx --}}
          <!--<img src="{{-- Auth::user()->userProfile->profile_picture ? asset(Auth::user()->userProfile->profile_picture) : asset('/admin/dist/img/user2-160x160.jpg') --}}" alt="{{-- Auth::user()->name --}}"  class="img-circle" alt="User Image">-->
        </div>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{ url('admin/questions') }}"><i class="fa fa-circle-o"></i>Questions list</a></li>
                <li><a href="{{ url('admin/question/create') }}"><i class="fa fa-circle-o"></i>Create question</a></li>
                <li><a href="{{ url('admin/outcomes') }}"><i class="fa fa-circle-o"></i>Outcomes</a></li>
                <li><a href="{{ url('admin/who_does_test') }}"><i class="fa fa-circle-o"></i>Who does the test</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{ url('admin/skill_development/categories') }}"><i class="fa fa-circle-o"></i>Video Categories </a></li>
                <li><a href="{{ url('admin/skill_development/videos') }}"><i class="fa fa-circle-o"></i>Video Lisitng </a></li>
                <li><a href="{{ url('admin/skill_development/video/add') }}"><i class="fa fa-circle-o"></i>Add Videos</a></li>
