...
<head>
  ...
  <title>{{ isset($tag->id) ? $tag->title : "Wexplore | Dashboard" }}</title>
  ...
  <link rel="stylesheet" href="{{ asset('/admin/custom/admin_custom.css') }}">
  <link rel="stylesheet" href="{{ asset('/admin/bootstrap/css/datepicker.min.css') }}">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  {{ Auth::user()->name }} @if(Auth::user()->surname) {{ Auth::user()->surname }} @endif
                </p>
              </li>
              <!-- Menu Body -->
              ...
              <li class="user-footer">
                <div class="pull-left">
                <a href="{{ URL::to('admin/user/'.\Auth::user()->id.'/edit') }}" class="btn btn-default btn-flat">Profile Settings</a>
                </div>
