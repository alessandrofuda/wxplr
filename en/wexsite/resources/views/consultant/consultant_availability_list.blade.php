			...
			@if (count($consultant_avails) > 0) 
				@foreach ($consultant_avails as $consultant_avail)
					<tr role="row" class="odd">
						...
						<td class="sorting_1">{{ $consultant_avail->getDate() }} - {{ $consultant_avail->getDate(\App\ConsultantAvailablity::START_TIME)  }} to {{ $consultant_avail->getDate(\App\ConsultantAvailablity::END_TIME)  }}
						</td>
