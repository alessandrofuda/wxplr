                            ...
                            <div class="items_group clearfix">
                               <div  style="margin-bottom:10px;padding-top:50px;" class="column one column_fancy_heading">
                                ...
                                <div style="margin-bottom: -6px; padding-bottom: 0px;" class="column one-third column_quick_fact">
									<p class="hrmargin_0" style="color:#3d3d3f; font-size:18px; line-height:22px;">We are a group people who believe that <strong>life is about continuous transformation</strong>, and some transitions may require more preparation and support, in order to become true learning experiences.<br> <br>
									We are people who believe that "<strong>a goal without a plan is just a wish</strong>"
										<em>(Antoine de Saint-Exupery)</em></p>
                                </div>
                                <!-- One Second (1/3) Column -->
                                <div class="column one-third column_quick_fact">
                                    <p class="hrmargin_0" style="color:#3d3d3f; font-size:18px; line-height:22px;">We believe that there is a very powerful sensation of liberty in undergoing many transitions during one’s lifetime, to learn new aspects of oneself and of others in different circumstances. <br><br>
									We believe in building strong foundations to enable you to soar high and achieve your full potential.</p>
                                </div>
                                <!-- One Fourth (1/3) Column -->
                                <div class="column one-third column_quick_fact">
                                    <p class="hrmargin_0" style="color:#3d3d3f; font-size:18px; line-height:22px;">We are experts in the area of <strong>career services</strong>, leveraging on technology and complementary expertise to create for you a unique personal and professional journey…because you are what you do, and what you do makes you who you are!</p>
                                </div>
