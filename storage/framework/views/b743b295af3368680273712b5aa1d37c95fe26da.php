								...
								<table border="0" cellspacing="0" cellpadding="0" class="m--button" style="border-collapse:separate;">
									<tr>
										<td align="center" style="-moz-border-radius:20px;-webkit-border-radius:20px;border-radius:20px;font-size:14px;padding:12px 15px;" bgcolor="#8fcb49">
											<a href="<?php echo e(url('login')); ?>" target="_blank" style="font-size:12px;line-height:12px;padding:6px 9px;font-weight:bold;font-family:Arial;color:#ffffff;text-decoration: none;-moz-border-radius:20px;-webkit-border-radius:20px;border-radius:20px;display:block;">
...
<?php if(isset($user->id)): ?>
	<?php $__env->startSection('unsubscribe'); ?>

		<a href="<?php echo e(UrlSigner::sign(route('delete-account', ['user_id' => $user->id ]), 7)); ?>" target="_blank">deleting account</a>
