 <!-- /.content-wrapper -->
  <footer class="main-footer">    
    <strong>Copyright &copy; <?php echo e(date('Y')); ?> <a href="<?php echo e(url('/')); ?>">Wexplore</a>.</strong> All rights
    reserved.
  </footer>
...
<script src="<?php echo e(asset('/custom/jquery.validate.js')); ?>"></script>
  <script src="<?php echo e(asset('/custom/add_ckeditor.js')); ?>"></script>
 <script src="<?php echo e(asset('/admin/plugins/timepicker/bootstrap-timepicker.min.js')); ?>"></script>
 <link rel="stylesheet" href="<?php echo e(asset('/admin/plugins/timepicker/bootstrap-timepicker.min.css')); ?>" type="text/css">
