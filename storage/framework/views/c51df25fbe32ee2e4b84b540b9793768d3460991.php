                            ...
                            <div class="items_group clearfix flex-container">
                                ...
                                <div class="column one-third column_quick_fact" style="background:rgba(0, 0, 0, 0.7);margin-top:40px; padding:20px;">
                                   ...
                                   <a class="button button_large aligncenter button_theme button_js" style="margin-bottom: 0" href="/service/payment/2"><span class="button_label">BUY NOW</span></a></div>
                                    ...
                                    <form method="post" action="<?php echo e(url('services')); ?>" style="margin-top: 6px;">
                                        <!-- CASELLE DI TESTO -->
                                        <div class="column one-second form-row">
                                            <input type="text" required placeholder="Name" name="name" value="<?php echo e(old('name')); ?>">
                                        </div>
                                        <div class="column one-second form-row">
                                            <input type="text" required placeholder="Surname" name="surname" value="<?php echo e(old('surname')); ?>">
                                        </div>
                                        <div class="column one-second form-row">
                                            <input type="text" required placeholder="Address" name="address" value="<?php echo e(old('address')); ?>">
                                        </div>
                                        <div class="column one-second form-row">
                                            <input type="text" required placeholder="Email" name="email" value="<?php echo e(old('email')); ?>">
                                        </div>
                                        <div style="margin-bottom: 10px;" class="column form-row">
                                            <textarea name="message" placeholder="Message" rows="2" cols="60"><?php echo e(old('message')); ?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <input type="radio" name="policy" required>
                                            <span style="color: white;">I authorize the treatment of my personal data pursuant to the Italian Legislative Decree on privacy 196/2003. <a class="text-white" href="/privacy-policy" target="_blank">Read the privacy policy</a></span>
                                        </div>
						...
						<div class="items_group clearfix">
							...
							<div id="orientation" class="column one column_fancy_heading">
								<div class="fancy_heading fancy_heading_icon">
									<h2 style="color:#1f87c7; background: url('/frontend/immagini/linea-titolo-blu.png') no-repeat bottom center; padding-bottom: 25px;font-family: 'Varela Round', sans-serif;">WHY PROFESSIONAL KIT?</h2>
								</div>
