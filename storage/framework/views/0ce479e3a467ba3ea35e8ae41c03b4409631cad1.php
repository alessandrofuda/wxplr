    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 margin-none">
        ...
        <?php endif; ?>
            <form method="POST" action="<?php echo e(url('register')); ?>">
                ...
                <?php if(app('request')->input('type') == 'professional' || app('request')->input('type') == 'skill'): ?>
            ...
            <a style="padding-left: 0px;" href="<?php echo e(URL::to('/auth/login')); ?>" class="text-center">I already have a membership</a>
    </div>
    </div>
