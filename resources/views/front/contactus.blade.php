					...
					<div class="section_wrapper clearfix">
						...
						<div class="form-group">
                          <label>Privacy Policy*</label>
							...
							<span>I authorize the treatment of my personal data pursuant to the General Data Protection Regulation (EU GDPR) 2016/679. <a href="/privacy-policy" target="_blank">Read the privacy policy</a></span>
						  </div>
                        </div>
                        {{ csrf_field() }}
