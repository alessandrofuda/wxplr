                                   ...
                                   <a class="button button_large aligncenter button_theme button_js" style="margin-bottom: 0" href="{{url('/service/payment/2')}}"><span class="button_label">BUY NOW</span></a></div>
                                    ...
                                    <form method="post" action="{{ url('services') }}" style="margin-top: 6px;">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <span style="color: white;">I authorize the treatment of my personal data pursuant to the General Data Protection Regulation (EU GDPR) 2016/679. <a class="text-white" href="/privacy-policy" target="_blank">Read the privacy policy</a></span>
                                        </div>
