<div class="content_wrapper clearfix">
		<div class="sections_group">
			...
			<div class="flv_sections_16 section" id="promobox">
							...
							<div class="column one column_fancy_heading">
								<div style="margin-top:40px;" class="fancy_heading fancy_heading_icon">
                                    ...
                                    <!-- One  Column -->
                                    <div class="column one column_promo_box">
										...
										Start from our <a href="/en/services#orientation">Global Orientation Test</a> to get a first picture.</span> </div></div>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- One Column -->
                                    <div class="column one column_promo_box">
										...
										<a href="/en/services#kit">Professional Kit</a> is the first step towards a more conscious and effective journey while still in your home country, with the support of a dedicated consultant.</span> </div>
                                              </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="column one column_promo_box">
										...
										Check out our <a href="/en/services#toolbox">Global Toolbox</a> and don’t worry: we will sort out everything with you! </span> </div> </div>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- One Column -->
                                    <div class="column one column_promo_box">
										...
										In the <a href="/en/services#skill">Skills Development</a> section you will find the most effective advises to progress in your journey, thanks to the support of both our qualified network of experts and of people who share their first-hand experiences.</span> </div></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                              ...
                              <!-- codice per servizi inizava qui -->
                                ...
                                <div class="column one-fourth column_icon_box">
                                    <div style="background:#fff; padding:10px; box-shadow: 0 0 5px #ccc;" class="icon_box icon_position_top no_border">
                                        ...
                                        <div style="margin-top: 20px;"class="aligncenter"><a class="button button_large button_theme button_js" href="/en/services#orientation"><span class="button_label">VIEW MORE</span></a></div>
                                    </div>
                                </div>
                                <!-- One Fourth (1/4) Column -->
                                <div class="column one-fourth column_icon_box">
                                        ...
                                        <a class="" href="/en/services#kit">
                                            ...
                                            <div class="desc_wrapper">
                                                <div  style="min-height: 180px;" class="desc">
                                                    ...
                                                    <p style="text-align:left;" class="hrmargin_0">
                                                        Your basic package to kick-start your international career Map your professional journey from the application to the recruitment phase, and get faster to your final destination, by avoiding slowdowns and pitfalls</p>
                                                </div>
                                            </div>
                                        </a>
                                        <div style="margin-top: 20px;"class="aligncenter"><a class="button button_large button_theme button_js" href="/en/services#kit"><span class="button_label">VIEW MORE</span></a></div>
                                    </div>
                                </div>
                                <!-- One Fourth (1/4) Column -->
                                <div class="column one-fourth column_icon_box">
                                        ...
                                        <a class="" href="/en/services#skill">
                                            ...
                                            <div class="desc_wrapper">
                                                <div  style="min-height: 180px;" class="desc">
                                                    ...
                                                    <p style="text-align:left;" class="hrmargin_0">
                                                        Improve your attractiveness as a global talent with our e-learning offer Browse through our content library and develop your soft skills to increase your personal and professional effectiveness</p>
                                                </div>
                                            </div>
                                        </a>
                                        <div style="margin-top: 20px;"class="aligncenter"><a class="button button_large button_theme button_js" href="/en/services#skill"><span class="button_label">VIEW MORE</span></a></div>
                                    </div>
                                </div>
                                <!-- One Fourth (1/4) Column -->
                                ...
                                <div class="column one-fourth column_icon_box">
                                    <div style="background:#fff; padding:10px; box-shadow: 0 0 5px #ccc;" class="icon_box icon_position_top no_border">
                                        ...
                                        <div style="margin-top: 20px;"class="aligncenter"><a class="button button_large button_theme button_js" href="/en/services#toolbox"><span class="button_label">VIEW MORE</span></a></div>
                                    </div>
                                </div>
