...
<div class="Profile_details col-md-9 col-sm-10 col-xs-12 columns-center">
	<div class="Profile_details_main">
		...
		<form action="{{ url('consultant/profile/update')}}" method="POST" class="Profile-Data-form" enctype = "multipart/form-data">
			{{ csrf_field() }}
			...
			<div class="form-group has-feedback">
				...
				<div class="date">
					<input class="form-control" @if(isset($consultant->consultantProfile->pin_number) && $consultant->consultantProfile->pin_number != '') value="{{ $consultant->consultantProfile->pin_number }}" @endif name="pin_number" required type="text" id="pin_number">
				</div>
			</div>
...
<div class="Profile_details  col-md-9 col-sm-10 col-xs-12 columns-center">
		<div class="Profile_details_main">
			<h3 class="Profile_Data_heading">Login Data</h3>
				<div class="columns-center" style="display: none;" id="edit_login_data">
					...
					<form action="{{ url('consultant/profile/updatelogin') }}" method="POST">
						{{ csrf_field() }}
						<input type="hidden" name="user_id" value="{{ $consultant->id }}">
						{{ csrf_field() }}
						<input type="hidden" name="user_id" value="{{ $consultant->id }}">
			...
			<div class="Profile-Data"  id="view_login_data">
				<a  class="edit_profile" id="edit_login"><span class="glyphicon glyphicon-pencil"></span></a>
				<ul>
	...
	jQuery(function ($) {  // aggiunto questo wrapper per evitare conflitti tra librerie
