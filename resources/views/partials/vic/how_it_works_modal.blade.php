			...
			<div class="modal-body">
				...
				<div class="modal-text">
					<ol>
						...
						<li>VIC recommends a program based on 9 steps</li>
						...
						<li>Once you complete a set of steps, you will receive a summary report on the phases you will have completed</li>
						<li>The 2 reports are: preparation (from step 1 to 4) and hunt (from step 5 to 9). The reports contain all the information you have discussed with VIC, and additional sources for your job search</li>
					</ol>
					<br><p>Time to get started !</p><br>
				</div>
				{{-- <div class="modal-img">
