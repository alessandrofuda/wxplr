...
<script src="{{ asset('/custom/jquery.validate.js') }}"></script>
  <script src="{{ asset('/custom/add_ckeditor.js') }}"></script>
 <script src="{{ asset('/admin/plugins/timepicker/bootstrap-timepicker.min.js') }}"></script>
 <link rel="stylesheet" href="{{ asset('/admin/plugins/timepicker/bootstrap-timepicker.min.css') }}" type="text/css">
