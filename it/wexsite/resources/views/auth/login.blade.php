@extends('front.new_layout')
  ...
  <div class="user_login_form">
   <div class="fancy_heading fancy_heading_icon">
									<h2 style="color:#54b141; background: url(/it/frontend/immagini/linea-titolo-verde.png) no-repeat bottom center; padding-bottom: 25px;">LOGIN</h2>
								</div>
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 margin-none">
      ...
      <a href="{{ URL::to('/password/email') }}">Ho perso la password</a><br>
      <a href="{{ URL::to('register') }}" class="text-center">Registra un nuovo account</a><br>
