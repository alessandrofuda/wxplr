		...
		{{--*/ $price = $amount; /*--}}
                ...
                @if($price > 0)
                    <div id="payment-method-div" class="form-group">
                        <div class="col-md-12"><input checked type="radio" value="1" id="paypal-method" name="payment_method"> Paypal <input id="card-method" type="radio" value="2" name="payment_method"> Credit Card
                        </div>
                    </div>
                    <br/>
                    ...
                    <script>
                        ...
                        if($("#card-method").is(":checked")) {
                           ...
                           /* checkout.teardown(function () {
                            ...
                            var checkout;
                            braintree.setup(clientToken, 'custom', { onReady: function (integration) {
                                checkout = integration;
                            },id: 'checkout'});*/
                        }
                ...
                <div class="ligle_terms servic_Payment_method">
                    <span class="paymentOption_div">
                        <input   type="checkbox" required name="tos">
                            <i></i>
                            <b>I have read and accepted the General <a href="/it/condizioni-vendita" target="_blank">Terms and Conditions</a> and have read the <a href="/it/informativa-privacy" target="_blank">Privacy Policy</a></b>
                    </span>
                    <span class="paymentOption_div">
                            <input  type="checkbox" required name="tos">
                            <i></i>
...
var isFormPagamentoValido = function() {
    var isValido = true;
    // verifica TOS
...
$(function() {
    ...
    $("input[name='credit_card_number']").keyup(checkAbilitazioneButtonOrderNow);
