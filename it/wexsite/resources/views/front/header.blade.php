                                ...
                                <div class="menu_wrapper">
                                    <nav id="menu">
                                        <ul class="menu" id="menu-main-menu">
                                            ...
                                            @if(!\Auth::check())
                                            <li>
                                                <a href="/en/auth/login"><span>Login</span></a>
                                            </li>
                                            @else
                                            <li>
                                                ...
                                                @if(\Auth::user()->isConsultant())
                                                    <li>
                                                        <a href="/it/consultant/dashboard"><span><img src="/en/frontend/immagini/user.png" alt="" /></span></a>
                                                    </li>
                                                @else
                                                    <li>
                                                        <a href="/it/user/dashboard"><span><img src="/en/frontend/immagini/user.png" alt="" /></span></a>
                                                    </li>
                                                @endif
                                            @endif
                                            <li>
                                                <a href="/en"><span><img src="/en/frontend/immagini/Flag-uk.jpg" alt="" /></span></a>
                                            </li>
