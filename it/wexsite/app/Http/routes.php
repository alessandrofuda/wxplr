...
/*Route::get('phpinfo', function() {
	...
	Route::get('/', array('as' => 'landing-page', 'uses' => 'LandingPageController@index'));
	...
	Route::get('contatti', array('as' => 'contact', 'uses' => 'PagesController@contactform'));
	...
	Route::get('auth/login', function() {
		return Redirect::to('https://www.wexplore.co/en/auth/login');
	});
	...
	Route::get('register', function() {
		return Redirect::to('https://www.wexplore.co/en/register');
	});
	...
	Route::get('login', function() {
		return Redirect::to('https://www.wexplore.co/en/login');
	});
	// Route::get('consultant/register', array('as' => 'consultant_register', 'uses' => 'Auth\AuthController@getConsultantRegister'));
	Route::get('consultant/register', function() {
		return Redirect::to('https://www.wexplore.co/en/consultant/register');
	});
	...
	Route::get('client/register', function() {
		return Redirect::to('https://www.wexplore.co/en/client/register');
	});
...
// Service Payment
	...
	Route::get('service/payment/{service_id}', function($service_id) {
		$url = 'https://www.wexplore.co/en/service/payment/' . $service_id;
		return Redirect::to($url);
	});

//Partner page
	Route::any('/partner','PagesController@partners');
...
/*Route::post('service/payment/process', array(
	...
	// Service Page routes..
	Route::get('servizi', array('as'=>'frontServices','uses'=>'PagesController@showServices'));
